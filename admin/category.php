...
<label class="control-label" for="basicinput">Categoria Nome</label>
<div class="controls">
<input type="text" placeholder="digite nome da categoria"  name="category" class="span8 tip" required>
</div>
</div>


<div class="control-group">
											<label class="control-label" for="basicinput">Descricao</label>
											<div class="controls">
