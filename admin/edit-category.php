...
<div class="controls">
<input type="text" placeholder="Digite aqui (ex.Bebidas)"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>


<div class="control-group">
											<label class="control-label" for="basicinput">DESCRICAO DA CATEGORIA</label>
											<div class="controls">
