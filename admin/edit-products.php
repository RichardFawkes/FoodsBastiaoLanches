...
if(isset($_POST['submit']))
{
	...
	//ATUALIZACA DOS PRODUTOS
$sql=mysqli_query($con,"UPDATE products SET `productName` = '$productname' where id='$pid' ");
$sql=mysqli_query($con,"UPDATE products SET `productCompany` = '$productcompany' where id='$pid' ");
$sql=mysqli_query($con,"UPDATE products SET `productPrice` = '$productprice' where id='$pid' ");
$sql=mysqli_query($con,"UPDATE products SET `productPriceBeforeDiscount` = '$productpricebd' where id='$pid' ");
$sql=mysqli_query($con,"UPDATE products SET `productDescription` = '$productdescription' where id='$pid' ");
$sql=mysqli_query($con,"UPDATE products SET `productAvailability` = '$productavailability' where id='$pid' ");
...
<head>
	...
	<title>Admin| PERSONALIZAR PRODUTOS</title>
...
{?>
									...
									<strong>Otimo!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Produto!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">PREÇO SEM DESCONTO:</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">PREÇO COM DESCONTO:</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">DETALHES DO PRODUTO:</label>
<div class="controls">
...
<!-- EXCLUIR DEPOIS VALOR DA ENTREGA ISSO NAO TEM! SO PARA APAGAR OS VALORES  -->
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">TROCAR IMAGEM</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">TROCAR IMAGEM</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">TROCAR IMAGEM</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn btn-primary btn-large">ATUALIZAR</button>
											</div>
										</div>
									</form>
							</div>
