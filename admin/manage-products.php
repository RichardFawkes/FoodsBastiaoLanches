...
<?php } ?>
								...
								<table cellpadding="0" cellspacing="0" class=" table table-bordered table-striped	 display" width="100%">
									<thead>
										<tr>
											<th>#</th>
											<th>Nome Produto</th>
...
?>									
										<tr>
											...
											<td>
											<a href="edit-products.php?id=<?php echo $row['id']?>" ><i class="icon-edit icon-large"></i></a>
										</tr>
										<?php $cnt=$cnt+1; } ?>
