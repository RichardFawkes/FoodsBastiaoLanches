...
<head>
	...
	<title>Admin|Atualizar imagem do produto</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Atualizar imagem do produto 1</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Inserir Nova Imagem 1 Produto</label>
<div class="controls">
...
<?php } ?>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn btn-success btn-large">ATUALIZAR</button>
											</div>
										</div>
									</form>
							</div>
