...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="ID de e-mail inválido ou nenhum contato";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>Portal Bastião | Esqueceu a senha</title>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Seu Email<span>*</span></label>
		    <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required >
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Numero Contato <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Trocar</button>
	</form>					
</div>
<!-- Sign-in -->
