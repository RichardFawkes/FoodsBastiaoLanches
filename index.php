		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-warning">QUERO!</a></div>
			</div><!-- /.product -->
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">FREESHAKES</h3>
...
<?php include('includes/footer.php');?>
	...
	<script src="https://kit.fontawesome.com/52dfdbb2c2.js"></script>
